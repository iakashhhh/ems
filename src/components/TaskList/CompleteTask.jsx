  ...
  return (
    <div className="flex-shrink-0 h-full w-[300px] p-5 bg-[#2a2a2a] rounded-xl shadow-md hover:shadow-lg transition">
      ...
      <div className="flex justify-between items-center">
        <h3 className="bg-green-700 text-gray-100 text-xs px-3 py-1 rounded-full">
      ...
      {/* Status */}
      <div className="mt-6">
        <span className="w-full block text-center bg-green-600 text-white font-semibold py-2 rounded-lg">
          Completed ✅
        </span>
      </div>
    </div>
